package org.example.Lesson_3.HomeWork;
...
class DoublyLinkedList {
     ...
     * Для выполнения сортировки мы проходимся по списку и на каждой итерации выбираем узел с индексом i.
     * Затем сравниваем его со всеми узлами с индексом меньше i и
     ...
     * Метод swapNodes меняет местами два узла списка. В данном примере мы меняем местами
